...
for f in $HIVE_HOME/jdbc/*.jar; do
  if [ "$HADOOP_CLASSPATH" ]; then
    export HADOOP_CLASSPATH=$HADOOP_CLASSPATH:$f
  else
    export HADOOP_CLASSPATH=$f
...
export HADOOP_DATANODE_OPTS="-Dhadoop.security.logger=WARN,RFAS $HADOOP_DATANODE_OPTS"
