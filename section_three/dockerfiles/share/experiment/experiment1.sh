...
hadoop jar ~/experiment/experiment-1.0.jar Triangle_Count /data/graphTriangleCount/twitter_graph_v2.txt output/twitter_ud 18
hadoop jar ~/experiment/experiment-1.0.jar Directed_Triangle_Count /data/graphTriangleCount/twitter_graph_v2.txt output/twitter_d 18
...
hadoop jar ~/experiment/experiment-1.0.jar Directed_Triangle_Count /data/graphTriangleCount/gplus_combined.unique.txt output/gplus_d 18
